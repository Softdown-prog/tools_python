...
SOURCE_ROOT = os.path.join(TOOLS_ROOT, 'output', 'cleaner_female_canonical_walk')
DESTINATION_ROOT = os.path.join(PROJECT_ROOT, 'assets', 'pedestrians', 'cleaner_female_canonical_walk')

# Same shared source canvas/crop as canonical_walk. No frame-specific alpha crop.
CROP_X = 64
CROP_Y = 32
CROP_WIDTH = 128
CROP_HEIGHT = 192
...
for direction in ('se', 'sw', 'nw', 'ne'):
    ...
    for index in range(4):
        ...
        cropped = common_crop(image, 'cleaner_female_runtime_{}_{}'.format(direction, index))
...
print('CLEANER_FEMALE_RUNTIME directions=4 frame_size={}x{} character_height={}'.format(TARGET_WIDTH, TARGET_HEIGHT, TARGET_CHARACTER_HEIGHT))
